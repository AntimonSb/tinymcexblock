function StudioEditSubmit(runtime, element) {
  ...
  function initTinymce(){
    tinymce.init({
      ...
      plugins: ['image link media table textcolor paste'],
      paste_as_text: true,
      toolbar: 'fullscreen | newdocument undo redo | styleselect formatselect fontsizeselect | bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent |  link unlink anchor image media | forecolor backcolor table | hr removeformat | subscript superscript',
      image_advtab: true,
      body_id: 'tinymcebody',
